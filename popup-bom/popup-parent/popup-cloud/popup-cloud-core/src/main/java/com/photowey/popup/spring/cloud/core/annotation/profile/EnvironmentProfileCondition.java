 ...
 */
package com.photowey.popup.spring.cloud.core.annotation.profile;
...
class EnvironmentProfileCondition implements Condition {
    ...
    private String[] parseDynamicProfilesIfNecessary(ConditionContext context, Object profiles) {
        ...
        for (String profile : profileArray) {
            List<String> parsed = Stream.of(environment.resolvePlaceholders(profile).split(DEFAULT_DELIMITER)).toList();
