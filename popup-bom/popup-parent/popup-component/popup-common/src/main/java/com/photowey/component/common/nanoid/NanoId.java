...
public final class NanoId {
    ...
    private NanoId() {
        ...
        AssertionErrorThrower.throwz(NanoId.class);
    }
    ...
    public static String randomNormalNanoId(Integer size) {
        return NanoId.randomNanoId(NanoId.NORMAL_ALPHABET, size);
    }

    public static String randomShuffleNormalNanoId(Integer size) {
        return NanoId.randomNanoId(shuffleChars(NanoId.NORMAL_ALPHABET_STRING), size);
    }
