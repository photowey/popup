 ...
 */
@Data
@ConfigurationProperties(prefix = "popup.delayedqueue", ignoreUnknownFields = true)
public class DelayedQueueProperties implements Serializable {

    private static final long serialVersionUID = -6303655901271403076L;
