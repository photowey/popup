...
@Slf4j
@Component
public class TestEventListener2 implements DelayedQueueListener<TestEvent2> {
    ...
    public void onEvent(TestEvent2 event) {
        log.info("TestEventListener2:handle event2: [{}], event.id: [{}];event.topic: [{}]", event.getClass().getName(), event.getId(), event.getTopic());
    }
