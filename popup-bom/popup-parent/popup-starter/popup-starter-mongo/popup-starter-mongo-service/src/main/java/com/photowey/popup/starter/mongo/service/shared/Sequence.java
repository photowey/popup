package com.photowey.popup.starter.mongo.service.shared;

import com.photowey.popup.starter.mongo.service.time.DefaultTimeServiceImpl;
import com.photowey.popup.starter.mongo.service.time.TimeService;
...
public class Sequence {
    ...
    private final long twepoch = 1612296306777L;
    ...
    public Sequence() {
        ...
        this.timeService = new DefaultTimeServiceImpl();
    }

    public Sequence(long workerId, long datacenterId) {
        this(workerId, datacenterId, new DefaultTimeServiceImpl());
    }

    public Sequence(long workerId, long datacenterId, TimeService timeService) {
    ...
    protected long timeGen() {
        // 此处: 没有采用原项目的 SystemClock 实例
        // 而是采用 timeService 的方式来实现
