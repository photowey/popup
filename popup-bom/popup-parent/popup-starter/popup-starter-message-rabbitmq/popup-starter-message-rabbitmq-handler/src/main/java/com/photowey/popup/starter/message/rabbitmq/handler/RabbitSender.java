...
import com.photowey.popup.starter.message.handler.sender.Sender;
import com.photowey.popup.starter.message.handler.sender.SenderManager;
...
public interface RabbitSender extends Sender, SmartInitializingSingleton {
    ...
    String RABBIT_MESSAGE_SENDER_NAME = SenderManager.rabbit();
    String RABBIT_DELAYED_MESSAGE_SENDER_NAME = SenderManager.delayedRabbit();
    ...
    default String buildMessageId(String type, String data) {
        String dataId = NanoidUtils.randomLowerNanoId(NanoidUtils.ALPHABET_NUMBER, DEFAULT_DATA_ID_SIZE);
